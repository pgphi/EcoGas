...
GAS_PROVIDERS = {"uniper_url": "https://agsi.gie.eu/api?country=DE&company=21X000000001127H",
                 ...
                 "swkiel_url": "https://agsi.gie.eu/api?country=DE&company=21X000000000051Y",
...
def get_gas_info(url):
    ...
    try:
        ...
        cur_Capacity = data[0].get("gasInStorage")  # In TWh
        cur_withdraw = data[0].get("withdrawal")  # in Gwh/d
        cur_trend = data[0].get("trend")  # Change in Percent %

        return [provider_name, cur_gasInStorage, cur_withdraw, cur_trend, cur_Capacity]

    except IndexError:
        provider_name = "Currently N/A"
        cur_gasInStorage = "N/A"  # In Percent %
        cur_Capacity = "N/A"  # In TWh
        cur_withdraw = "N/A"  # in Gwh/d
        cur_trend = "N/A"  # Change in Percent %
